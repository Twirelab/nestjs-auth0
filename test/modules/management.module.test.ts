...
const testServiceOptions: ManagementClient.ManagementClientOptionsWithClientCredentials =
  {
    domain: "test.com",
    audience: "test",
...
describe("Authentication Module", () => {
  class TestService implements ManagementOptionsFactory {
    createAuth0Options(): ManagementClient.ManagementClientOptionsWithClientCredentials {
